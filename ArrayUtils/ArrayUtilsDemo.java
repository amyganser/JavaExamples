...
public class ArrayUtilsDemo
{
    public static void main(String[] args)
    {
        ...
        System.out.println();
        System.out.println("Testing ArrayUtils class exception handling - 7/29/2010");
        System.out.println();
...

        {
            ...
            int[] list3 = {5, 10, 5, 15, 5, 20};
            testIndexOf(list3, 5, 0);
            testIndexOf(list3, 10, 1);
            testIndexOf(list3, 15, 3);
            testIndexOf(list3, 20, 5);
            testIndexOf(list3, 0, -1);
            testLastIndexOf(list3, 5, 4);
            testLastIndexOf(list3, 15, 3);
            testLastIndexOf(list3, 10, 1);
            testLastIndexOf(list3, 20, 5);
